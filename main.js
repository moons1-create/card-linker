// 1. Lógica Visual: Lluvia de píxeles (Exactamente tu código original)
(() => {
...
/* =========================
   2. Lógica del Formulario y UI (Optimizada para Wallet)
   ========================= */
...
// Algoritmo de Luhn (Validación real de tarjeta)
function luhn(value){
...
// Interacción en tiempo real (Actualizar la tarjeta visual)
...
numInput?.addEventListener("input", (e) => {
    ...
    // Formatear con espacios para el input y la tarjeta visual
...
// Enviar Formulario (Disparo de Wallet)
form?.addEventListener("submit", (e) => {
    ...
    // Activar pantalla de carga (Aquí es donde Chrome lanza el popup)
